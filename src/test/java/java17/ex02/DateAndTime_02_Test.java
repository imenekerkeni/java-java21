...
public class DateAndTime_02_Test {
	...
	public void test_localDate_of() {
		...
		// TODO En exploitant les méthodes de l'objet result, valoriser les variables
	...
	public void test_localDate_format_with_hour() {
		...
		// TODO Formatter la date pour avoir "11/03/2015 00:00:00"
		// MAIS LocalDate n’a pas d’heure → exception attendue
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
		localDate.format(formatter); // provoque l’exception
	}
